...
! function(n, t) {
	"object" == typeof exports && "undefined" != typeof module ? module.exports = t() : "function" == typeof define &&
		define.amd ? define(t) : (n = "undefined" != typeof globalThis ? globalThis : n || self).fullpage = t()
}(this, (function() {
	"use strict";
	var n, t, e, i;
	Array.prototype.find || Object.defineProperty(Array.prototype, "find", {
		...
		var t = function(n) {
			var t = Number(n);
			return isNaN(t) ? 0 : 0 !== t && isFinite(t) ? (t > 0 ? 1 : -1) * Math.floor(Math
				.abs(t)) : t
		}(n);
		...
		for (var u, l = i(o.length), c = t(e) ? Object(new e(l)) : new Array(l), s = 0; s < l;) u =
			o[s], c[s] = a ? void 0 === r ? a(u, s) : a.call(r, u, s) : u, s += 1;
		return c.length = l, c
	}));
	var o = window,
		r = document,
		...
		f = ["parallax", "scrollOverflowReset", "dragAndMove", "offsetSections", "fadingEffect",
			"responsiveSlides", "continuousHorizontal", "interlockedSlides", "scrollHorizontally",
			"resetSliders", "cards", "dropEffect", "waterEffect"
		];
	...
	function g(n) {
		...
		for (var t = 1, e = arguments.length; t < e; ++t) {
			var i = arguments[t];
			if (i)
				for (var o in i) i.hasOwnProperty(o) && "__proto__" != o && "constructor" != o && (
					"[object Object]" !== Object.prototype.toString.call(i[o]) ? n[o] = i[o] : n[o] = g(n[
						o], i[o]))
		}
		return n
	}
	...
	function A(n, t) {
		n = E(n) ? n[0] : n;
		for (var e = null != t ? p(t, n.parentNode) : n.parentNode.childNodes, i = 0, o = 0; o < e
			.length; o++) {
			if (e[o] == n) return i;
			1 == e[o].nodeType && i++
		}
	...
	function E(n) {
		return "[object Array]" === Object.prototype.toString.call(n) || "[object NodeList]" === Object
	...
	function Q(n, t) {
		return (n.matches || n.t || n.msMatchesSelector || n.mozMatchesSelector || n.webkitMatchesSelector || n
			.oMatchesSelector).call(n, t)
	}
	...
	o.NodeList && !NodeList.prototype.forEach && (NodeList.prototype.forEach = function(n, t) {
		...
		return n >>= 0, t = String(void 0 !== t ? t : " "), this.length > n ? String(this) : ((n -= this
			.length) > t.length && (t += Array.apply(null, Array(n)).map((function() {
			return t
	...
	var fn = {
			...
			j: function(n, t) {
				var e = this;
				return "object" !== sn(this.D[n]) && (this.D[n] = []), this.D[n].push(t),
					function() {
			...
			L: function(n) {
				for (var t = this, e = arguments.length, i = new Array(e > 1 ? e - 1 : 0), o = 1; o <
					e; o++) i[o - 1] = arguments[o];
	...
	var rt = function(n) {
			this.anchor = n.anchor, this.item = n.item, this.index = n.index(), this.isLast = this.index === n
				.item.parentElement.querySelectorAll(n.selector).length - 1, this.isFirst = !this.index, this
				.isActive = n.isActive
		},
		at = function(n, t) {
			this.parent = this.parent || null, this.selector = t, this.anchor = U(n, "data-anchor") || tt()
				.anchors[A(n, tt().sectionSelector)], this.item = n, this.isVisible = d(n), this.isActive = m(n,
					An), this.an = m(n, In) || null != p(Hn, n)[0], this.un = t === tt().sectionSelector, this
				.ln = F(n, Nn) || F(n, bn), this.index = function() {
	...
	function pt(n, t) {
		!tt().autoScrolling || tt().scrollBar || n.self != window && m(n, Cn) ? n.self != window && m(n, Cn) ? n
			.scrollLeft = t : n.scrollTo(0, t) : n.style.top = t + "px"
	}
	...
	function kt(n, t, e, i) {
		var r, a = function(n) {
				return n.self != o && m(n, Cn) ? n.scrollLeft : !tt().autoScrolling || tt().scrollBar ? H() : n
					.offsetTop
			}(n),
			u = t - a,
			l = !1,
		...
		dn({
			...
			if (vn.K) {
				var v = t;
				e && (v = o.fp_easings[tt().easing](f, a, u, e)), f <= e && pt(n, v), f < e ? window
					.requestAnimationFrame(Mt) : void 0 === i || l || (i(), dn({
						K: !1
					}), l = !0)
			} else l || c || (i(), dn({
				K: !1
	...
	function Pt(n) {
		...
		p("video, audio", t).forEach((function(n) {
			...
			/youtube\.com\/embed\//.test(U(n, "src")) && !n.hasAttribute("data-keepplaying") && n
	...
	function Ct(n) {
		tt().lazyLoading && p(
			...
			vt(n)).forEach((function(n) {
			if (["src", "srcset"].forEach((function(t) {
					var e = U(n, "data-" + t);
					null != e && e && (un(n, t), n.addEventListener("load", (
					function() {})))
				})), Q(n, "source")) {
	...
	function qt(n, t, e) {
		...
		l.pn = (i = l.prevSlideIndex, o = l.slideIndex, i == o ? "none" : i > o ? "left" : "right"), l
			.direction = l.direction ? l.direction : l.pn, l.localIsResizing || dn({
				G: !1
			}), tt().onSlideLeave && !l.localIsResizing && "none" !== l.pn && Y(tt().onSlideLeave) && !1 === jt(
				"onSlideLeave", l) ? dn({
				H: !1
			}) : (D(t, An), j(W(t), An), Oe(), l.localIsResizing || (Pt(l.prevSlide), Ct(t)), function(n) {
					!tt().loopHorizontal && tt().controlArrows && (X(p(qn, n.section), 0 !== n.slideIndex), X(p(
						Yn, n.section), null != T(n.destiny)))
				}(l), a.isActive && !l.localIsResizing && Nt(l.slideIndex, l.slideAnchor, l.anchorLink),
				function(n, t, e) {
					var i, o, r = t.destinyPos;
					if (i = t.slidesNav, o = t.slideIndex, tt().slidesNavigation && null != i && (j(p(xn, i),
							An), D(p("a", p("li", i)[o]), An)), dn({
							scrollX: Math.round(r.left)
						}), tt().css3) {
						var a = "translate3d(-" + Math.round(r.left) + "px, 0px, 0px)";
						s.test.gn[t.sectionIndex] = a, y(gt(p(Nn, n)), bt(a)), clearTimeout(Wt), Wt =
							setTimeout((function() {
								$t(t)
							}), tt().scrollingSpeed)
					} else s.test.left[t.sectionIndex] = Math.round(r.left), kt(n, Math.round(r.left), tt()
	...
	function Zt() {
		...
		tt().lazyLoading && n && p(".fp-section:not(.active)").forEach((function(n) {
			var t, e, i, o, r;
			e = (t = n.getBoundingClientRect()).top, i = t.bottom, o = e + 2 < vn.tn && e > 0, r =
				i > 2 && i < vn.tn, (o || r) && Ct(n)
		}))
	}
	...
	function te() {
		...
		for (var i = "", o = 0; o < hn().C.length; o++) {
			var a = hn().C[o],
				u = "";
			tt().anchors.length && (u = a.anchor), i += '<li><a href="#' + encodeURI(u) +
				'"><span class="fp-sr-only">' + It(a.index(), "Section") + "</span><span></span></a>";
			var l = tt().navigationTooltips[a.index()];
			void 0 !== l && "" !== l && (i += '<div class="fp-tooltip fp-' + tt().navigationPosition + '">' +
				l + "</div>"), i += "</li>"
		}
	...
	function ie(n, t) {
		...
		e = n, tt().menu && tt().menu.length && p(tt().menu).forEach((function(n) {
			...
			function(n, t) {
				var e = p(jn)[0];
				tt().navigation && null != e && "none" !== e.style.display && (j(p(xn, e), An), D(n ? p(
					'a[href="#' + n + '"]', e) : p("a", p("li", e)[t]), An))
			}(n, t)
	}
	Vt.m = {
		up: !0,
	...
	})), s.setRecordHistory = Xt, s.setAutoScrolling = Jt, s.test.setAutoScrolling = Jt, (new Date)
	.getTime();
	var oe, re, ae, ue, le, ce, se = (re = !0, ae = (new Date).getTime(), ue = !o.fullpage_api, function(n, t) {
		var e = (new Date).getTime(),
			i = "wheel" === n ? tt().scrollingSpeed : 100;
		return re = ue || e - ae >= i, ue = !o.fullpage_api, re && (oe = t(), ae = e), void 0 === oe ||
			oe
	});
	...
	function ve(n, t, e) {
		...
		if (null != i) {
			var o, r, a = function(n) {
					...
					return t > w() ? (o || a) && "bottom" !== a || (i = r) : (o || vn.W && null == T(n)) && (i =
						r), dn({
						nn: i
					}), i
				}(i),
			...
			if (!(hn().F.item == i && !vn.W || tt().scrollBar && H() === u.dtop && !m(i, "fp-auto-height"))) {
				if (null != u.activeSlide && (o = U(u.activeSlide, "data-anchor"), r = A(u.activeSlide, null)),
					!u.localIsResizing) {
					var l = u.yMovement;
					if (void 0 !== e && (l = e ? "up" : "down"), u.direction = l, Y(tt().beforeLeave) && !1 ===
						fe("beforeLeave", u)) return;
					if (Y(tt().onLeave) && !jt("onLeave", u)) return
				}
				tt().autoScrolling && tt().continuousVertical && void 0 !== u.isMovementUp && (!u
						.isMovementUp && "up" == u.yMovement || u.isMovementUp && "down" == u.yMovement) && (u =
						function(n) {
							dn({
								en: !0
							});
							var t = hn().F.item;
							return n.isMovementUp ? B(t, tn(t, En)) : N(t, en(t, En).reverse()), St(hn().F.item
									.offsetTop),
								function() {
									for (var n = p(Pn), t = 0; t < n.length; t++) Qt(n[t], "internal")
								}(), n.mn = t, n.dtop = n.element.offsetTop, n.yMovement = mt(hn().F, n
								.element), n
					...
					function(n) {
						...
						if (dn({
							...
							}), fn.L("onPerformMovement"), tt().css3 && tt().autoScrolling && !tt().scrollBar)
							yt("translate3d(0px, -" + Math.round(n.dtop) + "px, 0px)", !0), tt()
							.scrollingSpeed ? (clearTimeout(le), le = setTimeout((function() {
								de(n), dn({
									G: !t || s.test.wn
								})
							...
							var i = ht(n.dtop);
							s.test.top = -n.dtop + "px", clearTimeout(le), kt(i.element, i.options, tt()
								.scrollingSpeed, (function() {
	...
	function de(n) {
		dn({
			...
			function(n) {
				null != n.mn && (n.isMovementUp ? B(p(En)[0], n.mn) : N(p(En)[hn().C.length - 1], n.mn), St(hn()
					.F.item.offsetTop), function() {
					for (var n = p(Pn), t = 0; t < n.length; t++) Qt(n[t], "internal")
				}(), dn({
					en: !1
				}))
			}(n), Y(tt().afterLoad) && !n.localIsResizing && jt("afterLoad", n), Oe(), n.localIsResizing || Lt(n
				.element), D(n.element, On), j(W(n.element), On), Zt(), Me.bn(), dn({
				G: !0
	...
	function me(n) {
		var t = we();
		n ? t || (Jt(!1, "internal"), he(!1, "internal"), O(p(jn)), D(At, yn), Y(tt().afterResponsive) && tt()
			.afterResponsive.call(nt(), n)) : t && (Jt(et().autoScrolling, "internal"), he(et()
				.autoScrolling, "internal"), k(p(jn)), j(At, yn), Y(tt().afterResponsive) && tt()
			.afterResponsive.call(nt(), n))
	}
	...
	function be(n) {
		tt().verticalCentered && (!tt().scrollOverflow && Me.yn(n.item) || Me.Sn(n) || m(n.item, Bn) || D(n
			.item, Bn))
	}
	...
	var Te, Me = {
			...
			Mn: function() {
				tt().scrollOverflowMacStyle && !u && D(At, "fp-scroll-mac"), hn().vn.forEach((function(n) {
					if (!(n.slides && n.slides.length || m(n.item,
							"fp-auto-height-responsive") && we())) {
						var t, e = vt(n.item),
							i = Me.yn(n.item),
							o = (t = n).un ? t : t.parent;
						if (c) {
			...
			Ln: (Te = 0, function(n) {
				...
				Te = t, Y(tt().onScrollOverflow) && jt("onScrollOverflow", {
					position: t,
					direction: e
				}), m(n.target, In) && vn.G && Me.Pn(e, n.target) && Me.Cn() && fn.L(
					"onScrollOverflowScrolled", {
						direction: e
					})
			})
		},
	...
	function Oe() {
		vn.F = null, vn.C.map((function(n) {
				var t = m(n.item, An);
				n.isActive = t, n.an = Me.an(n.item), t && (vn.F = n), n.slides.length && (n
					.activeSlide = null, n.slides.map((function(t) {
						var e = m(t.item, An);
			...
			function() {
				...
				if (t && !e && xe) {
					...
					o && (vn.F.activeSlide = o, vn.F.activeSlide.isActive = !0, D(vn.F.activeSlide.item, An)),
	...
	function ke() {
		...
		Ae = Ee(vn.F), xe = Ee(vn.F ? vn.F.activeSlide : null), vn.R = t.length, vn.P = i.reduce((function(n,
		t) {
	...
	var je = function(n) {
		var t = this;
		[].push.call(arguments, tt().sectionSelector), at.apply(this, arguments), this.Tn = p(tt()
			.slideSelector, n), this.zn = Array.from(this.Tn).map((function(n) {
			return new Re(n, t)
	...
	function Ce(n) {
		...
		y(p(Nn, n.item), {
			...
			N(p(zn, t)[0], e), D(e, _n), D(e[0], Gn), D(e[1], "fp-next"), "#fff" !== tt()
				.controlArrowColor && (y(p(Yn, t), {
					"border-color": "transparent transparent transparent " + tt()
						.controlArrowColor
				}), y(p(qn, t), {
					"border-color": "transparent " + tt().controlArrowColor +
			...
			for (var o = 0; o < e; o++) L(J('<li><a href="#"><span class="fp-sr-only">' + It(o, "Slide",
				p(Rn, t)[o]) + "</span><span></span></a></li>"), p("ul", i)[0]);
			y(i, {
		...
		null != c && vn.F && (0 !== vn.F.index() || 0 === vn.F.index() && 0 !== c.index()) ? Qt(c.item,
			"internal") : D(e[0], An)
	}
	...
	function Ne(n) {
		var t = Fe();
		(Fe() || h(p(tt().sectionSelector, nt())).length !== hn().R) && !vn.en && (tt().observer && Le && Le
			.disconnect(), ke(), Oe(), tt().anchors = [], Z(p(jn)), Pe(), ot(), tt().navigation && te(),
			t && (Z(p(Vn)), Z(p(Kn))), hn().C.forEach((function(n) {
				n.slides.length ? t && Ce(n) : Se(n)
			}))), tt().observer && Le && p(bn)[0] && Le.observe(p(bn)[0], ze)
	}
	fn.j("bindEvents", (function() {
		var n, t, e;
		tt().observer && "MutationObserver" in window && p(bn)[0] && (n = p(bn)[0], t = ze, (e =
			new MutationObserver(Ne)).observe(n, t), Le = e), fn.j("contentChanged", Ne)
	})), s.Fn = Ne;
	var Be = function() {
		var n = !1;
		try {
	...
	var He, We, Ve, Ue, _e = (Ve = (new Date).getTime(), Ue = [], {
		Nn: function(n) {
			...
			He = Math.abs(n.wheelDeltaX) < Math.abs(n.wheelDelta) || Math.abs(n.deltaX) < Math.abs(n
				.deltaY) || !i;
	...
	function Je() {
		var n = hn().F.next();
		n || !tt().loopBottom && !tt().continuousVertical || (n = hn().C[0]), null != n ? ve(n, null, !1) : nt()
			.scrollHeight < At.scrollHeight && fn.L("scrollBeyondFullpage")
	}
	...
	var ii, oi, ri, ai, ui = 0,
		li = 0,
		ci = 0,
		si = 0,
		fi = (o.PointerEvent && (ai = {
			down: "pointerdown",
			move: "pointermove"
		}), ai),
		vi = {
	...
	function mi(n) {
		var t = {};
		return t.y = void 0 !== n.pageY && (n.pageY || n.pageX) ? n.pageY : n.touches[0].pageY, t.x = void 0 !==
			n.pageX && (n.pageY || n.pageX) ? n.pageX : n.touches[0].pageX, l && hi(n) && tt().scrollBar &&
			void 0 !== n.touches && (t.y = n.touches[0].pageY, t.x = n.touches[0].pageX), t
	}
	...
	function ki(n) {
		...
		9 === e ? function(n) {
			...
			if (! function(n) {
				...
				e ? null == F(e, ".fp-section.active,.fp-section.active .fp-slide.active") && (e = o(n)) :
					o(n);
				var a = e == i[0],
					u = e == i[i.length - 1],
					l = t && a;
				if (l || !t && u) {
					...
					var c = function(n) {
							var t, e = n ? "prevPanel" : "nextPanel",
								i = [],
								o = dt((vn.F && vn.F.activeSlide ? vn.F.activeSlide : vn.F)[e]());
							do {
		...
		}(n) : Q(t = r.activeElement, "textarea") || Q(t, "input") || Q(t, "select") || "true" == U(t,
			"contentEditable") || "" == U(t, "contentEditable") || !tt().keyboardScrolling || !o || (ii = n
			.ctrlKey, oi = setTimeout((function() {
				! function(n) {
					var t = n.shiftKey,
						e = r.activeElement,
	...
	s.moveSlideLeft = yi, s.moveSlideRight = Si, s.moveTo = xi, fn.j("bindEvents", (function() {
		K("blur", Di), _("keydown", ki), _("keyup", Ei), fn.j("onDestroy", Oi), fn.j(
			"afterSlideLoads", ji), fn.j("afterSectionLoads", Li)
	}));
	...
	function Fi(n) {
		n ? (function() {
			...
			var e = "onwheel" in r.createElement("div") ? "wheel" : void 0 !== r.onmousewheel ?
				"mousewheel" : "DOMMouseScroll",
				i = Ie();
			"DOMMouseScroll" == e ? r[n](t + "MozMousePixelScroll", Ni, i) : r[n](t + e, Ni, i)
		}(), nt().addEventListener("mousedown", Bi), nt().addEventListener("mouseup", Ii)) : (r
			.addEventListener ? (G("mousewheel", Ni, !1), G("wheel", Ni, !1), G("MozMousePixelScroll", Ni, !
				1)) : r.detachEvent("onmousewheel", Ni), nt().removeEventListener("mousedown", Bi), nt()
			.removeEventListener("mouseup", Ii))
	}
	...
	function Ni(n) {
		var t = (new Date).getTime(),
			...
			i = function(n, t) {
				...
				if (hn().B) {
					if (e) {
						var o;
						if (!(i || Xe("isNewKeyframe", "beyondFullpage") && _e.Bn())) return (o = ht(rn(hn().C)
							.item.offsetTop + rn(hn().C).item.offsetHeight)).element.scrollTo(0, o
							.options), dn({
							Hn: !1
						}), V(t), !1;
		...
		if (tt().autoScrolling && !ii && !e) {
			var r = (n = n || o.event).wheelDelta || -n.deltaY || -n.detail,
				...
				l = Math.abs(n.wheelDeltaX) < Math.abs(n.wheelDelta) || Math.abs(n.deltaX) < Math.abs(n
				.deltaY) || !u,
	...
	function _i(n) {
		...
		i != document && i ? ("touchend" === t && (Wi = !1, setTimeout((function() {
			Wi = !0
		}), 800)), ("mouseenter" !== t || Wi) && (tt().normalScrollElements.split(",").forEach((
			function(n) {
				if (!e) {
					var t = Q(i, n),
						o = F(i, n);
	...
	function Ji() {
		Qi || (tt().autoScrolling && !tt().scrollBar || !tt().fitToSection) && no(w()),
			function() {
				if (a)
					for (var n = 0; n < 4; n++) qi = setTimeout((function() {
	...
	function Zi(n) {
		if (!m(nt(), Tn)) {
			...
			vn.B || a && Ki(a + 1), dn({
				W: !1
			}), Y(tt().afterResize) && n && tt().afterResize.call(nt(), o.innerWidth, o.innerHeight), Y(tt()
				.afterReBuild) && !n && tt().afterReBuild.call(nt()), $(nt(), "afterRebuild")
		}
	}
	...
	function io() {
		if (!vn.V && !tt().lockAnchors) {
			...
			t && t.length && (t && t !== vn.U && !i || o || !vn.H && vn._ != e) && fn.L(
			"onScrollPageAndSlide", {
				Kn: t,
				slideAnchor: e
			})
		}
	...
	function ao(n) {
		var t = n.target;
		t && F(t, "#fp-nav a") ? ee.call(t, n.e) : Q(t, ".fp-tooltip") ? ne.call(t) : (Q(t, Un) || null != F(t,
			Un)) && Ht.call(t, n.e)
	}
	...
	function so(n) {
		...
		if (!vn.W && hn().F && (rn(hn().C), !hn().B && !hn().Hn && (!tt().autoScrolling || tt().scrollBar))) {
			...
			if (i = u, o = hn().F.item.offsetTop, r = o + w(), ("up" == i ? r >= H() + w() : o <= H()) && (m(
				hn().F.item, On) || (D(hn().F.item, On), j(W(hn().F.item), On))), e = (t = f[l]).item, !t
				.isActive) {
				dn({
					V: !0
				});
				...
				T && (h = T.anchor, d = T.index()), vn.G && (D(e, An), j(W(e), An), Y(tt().beforeLeave) && fe(
					"beforeLeave", M), Y(tt().onLeave) && jt("onLeave", M), Y(tt().afterLoad) && jt(
					"afterLoad", M), Pt(p), Ct(e), Lt(e), ie(y, S - 1), tt().anchors.length && dn({
					U: y
			...
			tt().fitToSection && vn.G && (clearTimeout(lo), lo = setTimeout((function() {
				vn.C.filter((function(n) {
					...
					return Math.round(t.bottom) === Math.round(w()) || 0 === Math
						.round(t.top)
				})).length || pe()
			}), tt().rn))
		}
	...
	function vo(n) {
		var t = n.index();
		void 0 !== tt().anchors[t] && n.isActive && ie(tt().anchors[t], t), tt().menu && tt().css3 && null != F(
			p(tt().menu)[0], bn) && p(tt().menu).forEach((function(n) {
			At.appendChild(n)
		}))
	}
	...
	function ho() {
		var n, t, e = hn().F,
			i = hn().F.item;
		D(i, On), Ct(i), Zt(), Lt(i), t = Ti((n = to()).section), n.section && t && (void 0 === t || t
		.index() !== A(ye)) || !Y(tt().afterLoad) || jt("afterLoad", {
			F: i,
			element: i,
			direction: null,
			anchorLink: e.anchor,
	...
	function mo() {
		ke(), Oe(), tt().scrollBar = tt().scrollBar || tt().hybrid, ot(),
			function() {
				y(ln(nt(), "body"), {
					height: "100%",
					position: "relative"
				...
				for (var n = hn().cn, t = 0; t < n.length; t++) {
					var e = n[t],
						i = e.Tn;
					e.item.setAttribute("data-fp-styles", U(e.item, "style")), Se(e), vo(e), i.length > 0 && Ce(
						e)
				}
				tt().fixedElements && tt().css3 && p(tt().fixedElements).forEach((function(n) {
					At.appendChild(n)
				})), tt().navigation && te(), p('iframe[src*="youtube.com/embed/"]', nt()).forEach((
					function(n) {
						var t, e;
						e = U(t = n, "src"), t.setAttribute("src", e + (/\?/.test(e) ? "&" : "?") +
							"enablejsapi=1")
					})), tt().scrollOverflow && Me.Mn()
			}(), po(!0), Hi(!0), Jt(tt().autoScrolling, "internal"), ge(), zt(), "complete" === r.readyState &&
			go(), K("load", go), ho(), ke(), Oe()
	}

	function wo() {
		var n = tt().licenseKey;
		"" === tt().licenseKey.trim() ? (v("error",
				"Fullpage.js requires a `licenseKey` option. Read about it on the following URL:"), v(
				"error", "https://github.com/alvarotrigo/fullPage.js#options")) : tt() && vn.Yn || r.domain
			.indexOf("alvarotrigo.com") > -1 ? n && n.length : (v("error",
				"Incorrect `licenseKey`. Get one for fullPage.js version 4 here:"), v("error",
				"https://alvarotrigo.com/fullPage/pricing")), m(xt, Mn) ? v("error",
				"Fullpage.js can only be initialized once and you are doing it multiple times!") : (tt()
				.continuousVertical && (tt().loopTop || tt().loopBottom) && (tt().continuousVertical = !1, v(
					"warn",
					"Option `loopTop/loopBottom` is mutually exclusive with `continuousVertical`; `continuousVertical` disabled"
					)), !tt().scrollOverflow || !tt().scrollBar && tt().autoScrolling || v("warn",
					...
					), !tt().continuousVertical || !tt().scrollBar && tt().autoScrolling || (tt()
					.continuousVertical = !1, v("warn",
					...
					if (e.length || t.length) {
						...
						(e.length || t.length) && v("error", '"' + n +
							'" is is being used by another element `' + i + "` property")
					}
				})))
	}
	...
	function bo(n, t) {
		var e;
		if (At = p("body")[0], xt = p("html")[0], Ot = p("html, body"), !m(xt, Mn)) return "touchWrapper", e =
			"string" == typeof n ? p(n)[0] : n, $n.touchWrapper = e,
			function(n) {
				Zn = g({}, $n, n), Jn = Object.assign({}, Zn)
			}(t),
			function(n) {
				Qn = n
			}("string" == typeof n ? p(n)[0] : n), fn.L("onInitialise"), wo(), s.getFullpageData =
			function() {
				return {
					options: tt()
				}
				...
				gn: function() {
					for (var n = [], t = 0; t < p(tt().sectionSelector, nt()).length; t++) n.push(
	...
	return fn.j("onDestroy", (function() {
			...
			K("scroll", so), r.body.addEventListener("scroll", so), fn.j("onScrollPageAndSlide", (
				function(n) {
		...
		function() {
				...
				dn({
					Yn: (tt().licenseKey, t = tt().licenseKey, u = function(t) {
						...
						return t.split("-").forEach((function(n, t) {
							if (t < 4) {
								for (var e = 0, i = 0; i < 4; i++) i !==
									l[t] && (e += Math.abs(r(n[i])),
										isNaN(n[i]) || c++);
								var o = a(e);
								s += o
							}
					...
					}(t), u && (tt().credits && u && e <= u.Qn && u.Jn === t.split(
						n[0])[4] || function(n) {
						var t = i[o()]().join("");
			...
			Jt(!1, "internal"), po(!0), Hi(!1), fo(!1), D(nt(), Tn), fn.L("onDestroy"), n && (St(0), p(
				"img[data-src], source[data-src], audio[data-src], iframe[data-src]", nt()).forEach((
				function(n) {
					un(n, "src")
				...
				tt().scrollOverflow && Me.Rn(n), j(n, "fp-table active " + On), U(n,
					"data-fp-styles") && n.setAttribute("style", U(n, "data-fp-styles")), m(
					n, kn) && !Xn && n.removeAttribute("data-anchor")
			})), wt(nt()), [Dn, Nn, zn].forEach((function(n) {
				...
				transition: "none"
			}), o.scrollTo(0, 0), [kn, Ln, Fn].forEach((function(n) {
				j(p("." + n), n)
			})))
